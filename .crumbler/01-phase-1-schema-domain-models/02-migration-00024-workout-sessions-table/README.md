# Migration 00024 - Workout Sessions Table

## Task

Create migration `migrations/00024_create_workout_sessions_table.sql` to create the workout_sessions table.
...
- Verify the table and indexes exist using `sqlite3`
